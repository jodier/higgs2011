...
class TLeptonAnalysis: public TNTuple
{
  ...
  public:
	...
	TLeptonAnalysis(TChain *chain): TNTuple(chain), elTrigger(0), muTrigger(0)
	{
		...
		m_stacoSF = new AnalysisMuonEfficiencyScaleFactors("STACO_CB", int_lum, "MeV", "./tools/MuonEfficiencyCorrections-01-01-04/share/");
...
/*		// variable names in p869
		if (not m_triggerNavigationVariables->isValid()) {
